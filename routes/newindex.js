...
router.get('/cgi/result/:tid', function(req, res) {
...
var gradeLibJson= [
        ...
        "spec": {
            ...
            "Silicon":
                {"min":0.0,"max":0.75},"Iron":{"min":0.0,"max":0.75,"isTramp":true
                },
            "Copper":
                {"min":0.05,"max":0.2},"Zinc":{"min":0.0,"max":0.1,"isTramp":false
                }
        },
        "enabled":true,
     },
...
var test = {
    "mResult": {
        ...
        "chemResults": [{
            ...
            "curve": {
                "curveFunction": {
                    "coefficients": [-0.2590126227297424,
                        87.41568408615176
                    ]
                },
                "numeratorLines": [{
            ...
            "curve": {
                "curveFunction": {
                    "coefficients": [-0.17474780914760418,
                        60.74193446062022
                    ]
                },
                "numeratorLines": [{
